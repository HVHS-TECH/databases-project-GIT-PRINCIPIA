...
export class HighScoreManager {
    ...
    static async getHighScore(cb, game) {
        ...
        const READ = await FB_IO.read("gameSite/" + game + "HighScores/" + FB_User.uid + '/score');
    ...
    static setHighScore(score, game) {
        ...
        FB_IO.write("gameSite/" + game + "HighScores/" + FB_User.uid + '/score', '', score);
        FB_IO.write("gameSite/" + game + "HighScores/" + FB_User.uid + '/username', '', FB_User.username);
    }
    //----------------------------------------------------------------------//
